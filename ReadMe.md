...
#Après l'avoir cloné
#Entrer dans la racine du projet
...
#Vous devez avoir un serveur LDAP deja parfaitement configuré, 
#sinon l'authentification et la connexion ne marcherons pas;
...
#Utiliser obligatoirement l'adresse IP 127.0.0.1 --> https://127.0.0.1:5000 dans le navigateur, 
#ou alors, modifier uniquement cette adresse IP dans le fichier src/static/js/choice.js
#C'est cette adresse qui permet de faire la recherche d'un utilisateur dans la base de données
